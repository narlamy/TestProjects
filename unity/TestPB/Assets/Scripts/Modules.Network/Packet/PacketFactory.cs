...
namespace N2.Network
{
    ...
    internal class PacketFactory
    {
        ...
        private PacketFactory()
        {
            ...
            foreach (var type in GameModule.FindTypes(ModuleCategory.Packet, myTypeFilter, null))
            {
        ...
        internal class ResponseData
        {
            ...
            /// </summary>
            [JsonProperty("FCFE", NullValueHandling = NullValueHandling.Ignore)]
            string mDat = null;

            /// <summary>
            /// 별도로 부여 받은 암호화키를 사용하지 않고 모듈의 기본 값 사용
            /// </summary>
            [JsonProperty("FD0E", NullValueHandling = NullValueHandling.Ignore)]
