...
namespace SF.Network
{
    ...
    /// </summary>
    internal static class PacketFactoryUtil
    {
        /// <summary>
        ...
        internal static ResponsePacket CreateResponse(this RequestPacket request, string responseText, int contentEmptyError = ServerError.ParsingError)
        {
            if (string.IsNullOrEmpty(responseText))
            {
                Dev.Logger.Log("[ImpSender] responseStream에서 문자열을 얻어 올 수 없습니다. (ReqType=\"" + request.GetType().Name + "\")");
